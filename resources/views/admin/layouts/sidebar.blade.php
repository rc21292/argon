      ...
      <ul class="navbar-nav align-items-center  ml-md-auto ">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-dark bg-default  dropdown-menu-right ">
            <div class="row shortcuts px-7">
              <a href="#!" class="col-6 shortcut-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#" >
            <i class="ni ni-chat-round text-white"></i>
          </a>
        </li>
        ...
        <div class="col-xl-2 col-md-6">
          <div class="card card-stats">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <h5 class="card-title text-uppercase text-muted mb-0">Products Online</h5>
        ...
        <div class="col-xl-2 col-md-6">
          <div class="card card-stats">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <h5 class="card-title text-uppercase text-muted mb-0">Low-Stock Product</h5>
        ...
        <div class="col-xl-2 col-md-6">
          <div class="card card-stats">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <h5 class="card-title text-uppercase text-muted mb-0">Total<br>Orders</h5>
        ...
        <div class="col-xl-2 col-md-6">
          <div class="card card-stats">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <h5 class="card-title text-uppercase text-muted mb-0">Complete Orders</h5>
        ...
        <div class="col-xl-2 col-md-6">
          <div class="card card-stats">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <h5 class="card-title text-uppercase text-muted mb-0">All<br>Shops</h5>
                  <span class="h2 font-weight-bold mb-0">350,897</span>
                </div>
        ...
        <div class="col-xl-2 col-md-6">
          <div class="card card-stats">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <h5 class="card-title text-uppercase text-muted mb-0">Approved Shops</h5>
                  <span class="h2 font-weight-bold mb-0">2,356</span>
                </div>
        ...
        <div class="col-xl-2 col-md-6">
          <div class="card card-stats">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <h5 class="card-title text-uppercase text-muted mb-0">Unapproved Shops</h5>
                  <span class="h2 font-weight-bold mb-0">924</span>
                </div>
